# Awesome Honeypots [![Awesome Honeypots](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,646 | 🐛 67 | 📅 2026-01-28 with stars
...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 435,646 | 🐛 67 | 📅 2026-01-28.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 13,414 | 🐛 24 | 📅 2024-06-07 - Some overlap here for artifact analysis.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 8,731 | 🐛 2 | 🌐 C | 📅 2026-01-29 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,832 | 🐛 8 | 🌐 Go | 📅 2026-01-26 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* SSH Honeypots
  ...
  * [endlessh](https://github.com/skeeto/endlessh) ⭐ 8,403 | 🐛 48 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner. ([docker image](https://hub.docker.com/r/linuxserver/endlessh))
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,155 | 🐛 40 | 🌐 Python | 📅 2026-02-07 - Cowrie SSH Honeypot (based on kippo).
  * [Kippo](https://github.com/desaster/kippo) ⭐ 1,711 | 🐛 83 | 🌐 Python | 📅 2023-11-19 - Medium interaction SSH honeypot.
  * [sshesame](https://github.com/jaksi/sshesame) ⭐ 1,708 | 🐛 17 | 🌐 Go | 📅 2024-10-21 - Fake SSH server that lets everyone in and logs their activity.
  * [ssh-honeypot](https://github.com/droberson/ssh-honeypot) ⭐ 669 | 🐛 11 | 🌐 C | 📅 2024-10-29 - Fake sshd that logs IP addresses, usernames, and passwords.
  ...
  * [Blacknet](https://github.com/morian/blacknet) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2024-03-21 - Multi-head SSH honeypot system.
  ...
  * [ssh-honeypotd](https://github.com/sjinks/ssh-honeypotd) ⭐ 18 | 🐛 2 | 🌐 C | 📅 2026-02-05 - Low-interaction SSH honeypot written in C.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 5,945 | 🐛 44 | 🌐 Python | 📅 2026-01-12 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Other/random
  ...
  * [OpenCanary](https://github.com/thinkst/opencanary) ⭐ 2,760 | 🐛 13 | 🌐 Python | 📅 2026-02-03 - Modular and decentralised honeypot daemon that runs several canary versions of services that alerts when a service is (ab)used.
...
* System instrumentation
  ...
  * [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,428 | 🐛 62 | 🌐 Go | 📅 2026-02-06 - Tool for exploration and tracing of the Windows kernel.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,015 | 🐛 12 | 🌐 HTML | 📅 2026-02-06 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
  ...
  * [dcept](https://github.com/secureworks/dcept) ⭐ 510 | 🐛 4 | 🌐 Python | 📅 2022-07-13 - Tool for deploying and detecting use of Active Directory honeytokens.
...
* Service Honeypots
  * [pyrdp](https://github.com/gosecure/pyrdp) ⭐ 1,751 | 🐛 63 | 🌐 Python | 📅 2025-07-27 - RDP man-in-the-middle and library for Python 3 with the ability to watch connections live or after the fact.
  ...
  * [honeypots](https://github.com/qeeqbox/honeypots) ⭐ 940 | 🐛 13 | 🌐 Python | 📅 2025-12-03 - 25 different honeypots in a single pypi package! (dns, ftp, httpproxy, http, https, imap, mysql, pop3, postgres, redis, smb, smtp, socks5, ssh, telnet, vnc, mssql, elastic, ldap, ntp, memcache, snmp, oracle, sip and irc).
...
* Server
  ...
  * [Heralding](https://github.com/johnnykv/heralding) ⭐ 387 | 🐛 19 | 🌐 Python | 📅 2024-05-21 - Credentials catching honeypot.
...
* ICS/SCADA honeypots
  ...
  * [Conpot](https://github.com/mushorg/conpot) ⭐ 1,426 | 🐛 117 | 🌐 Python | 📅 2024-12-24 - ICS/SCADA honeypot.
...
* PDF document inspector
  ...
  * [peepdf](https://github.com/jesparza/peepdf) ⭐ 1,423 | 🐛 49 | 🌐 Python | 📅 2024-08-19 - Powerful Python tool to analyze PDF documents.

* Web honeypots

  * [HellPot](https://github.com/yunginnanet/HellPot) ⭐ 1,094 | 🐛 12 | 🌐 Go | 📅 2025-12-19 - Honeypot that tries to crash the bots and clients that visit it's location.
  * [django-admin-honeypot](https://github.com/dmpayton/django-admin-honeypot) ⭐ 1,075 | 🐛 20 | 🌐 Python | 📅 2024-04-10 - Fake Django admin login screen to notify admins of attempted unauthorized access.
  * [galah](https://github.com/0x4D31/galah) ⭐ 633 | 🐛 5 | 🌐 Go | 📅 2025-07-24 - an LLM-powered web honeypot using the OpenAI API.
  ...
  * [Python-Honeypot](https://github.com/OWASP/Python-Honeypot) ⭐ 473 | 🐛 26 | 🌐 Python | 📅 2024-09-15 - OWASP Honeypot, Automated Deception Framework.
  ...
  * [Cloud Active Defense](https://github.com/SAP/cloud-active-defense?tab=readme-ov-file) ⭐ 103 | 🐛 21 | 🌐 JavaScript | 📅 2026-02-02 - Cloud active defense lets you deploy decoys right into your cloud applications, putting adversaries into a dilemma: to hack or not to hack?
  ...
  * [Lophiid](https://github.com/mrheinen/lophiid/) ⭐ 25 | 🐛 23 | 🌐 Go | 📅 2026-02-04 - Distributed web application honeypot to interact with large scale exploitation attempts.
...
* Server (Bluetooth)
  ...
  * [Bluepot](https://github.com/andrewmichaelsmith/bluepot) ⭐ 264 | 🐛 4 | 🌐 Java | 📅 2021-01-02
...
* SIP
  ...
  * [SentryPeer](https://github.com/SentryPeer/SentryPeer) ⭐ 205 | 🐛 4 | 🌐 C | 📅 2026-02-06 - Protect your SIP Servers from bad actors.
...
* Visualization
  ...
  * [The Intelligent HoneyNet](https://github.com/jpyorre/IntelligentHoneyNet) ⭐ 64 | 🐛 1 | 🌐 Python | 📅 2015-11-05 - Create actionable information from honeypots.
...
* Front Ends
  ...
  * [Tango](https://github.com/aplura/Tango) ⭐ 257 | 🐛 22 | 🌐 Shell | 📅 2018-10-18 - Honeypot Intelligence with Splunk.
